...
public class OrdersFormController {
    ...
    private void openDetailsUi(OrderDetailsTM newValue) throws IOException {
        ...
        OrderDetailsFormController detailsFormController =  fxmlLoader.getController();
        detailsFormController.loadData((newValue.getOrderId()));
    ...
    private void loadData() {
        ...
        for (Order o : Database.orderTable
            ...
            OrderDetailsTM tm = new OrderDetailsTM(
                    o.getOrderId(),new SimpleDateFormat("yyyy-MM-dd").format(o.getPlacedDate()),
